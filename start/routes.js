...
Route.group(() => {
  ...
  Route.get('advertisements/:id', 'AdvertisementController.show')
  Route.put('advertisements/:id', 'AdvertisementController.update').validator(
  ...
  Route.put('/addresses/:id', 'AddressController.update').validator(
    'Address/Update'
  )
  ...
  Route.post('/permissions', 'PermissionController.store').validator(
    'Permission/Store'
  )
  Route.get('/permissions/:id', 'PermissionController.show')
  Route.put('/permissions/:id', 'PermissionController.update').validator(
    'Permission/Update'
  )
